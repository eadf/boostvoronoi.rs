...
{
    let mut site1 = VSE::SiteEvent::<I1, F1, I2, F2>::new_2(Point::new(x1, y1), si1);
    site1.sorted_index_ = si1;
    let mut site2 = VSE::SiteEvent::<I1, F1, I2, F2>::new_2(Point::new(x2, y2), si2);
